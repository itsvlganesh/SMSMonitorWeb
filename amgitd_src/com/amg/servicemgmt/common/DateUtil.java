...
public class DateUtil 
{
    ...
    public static String[] months = {"January", "February",
    ...
    */
     ...
     */
	  ...
	  public static String formatDateTimeAsPattern(){
		  Date now = new Date();
	  ...
	  /**
	     ...
	     */
		  ...
		  public static String todaysDateWithYYYYMMDD(){
			  Date now = new Date();
			  SimpleDateFormat sm = new SimpleDateFormat("yyyy-MM-dd");
			  String dt =  sm.format(now);
			  return dt;
		  ...
		  /**
		     ...
		     */
			  ...
			  public static String todaysDateWithDDMMYY(){
				  Date now = new Date();
		 ...
		 /* public static Date getDateFomat(String reportDate)throws Exception{
			  
			  SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yy");
			  	Date date = formatter.parse(reportDate);
				Date dt = formatter.format(date);
	  ...
	  //calDate.add(calDate.WEEK_OF_MONTH, 1);  
...
//	String str = DateUtil.formatDateTimeAsPatternModified(1);
	
	String str = DateUtil.todaysDateWithDDMMYY();
	//System.out.println("str :"+str+"\t :"+DateUtil.getDateFomat(str));
	//rollDays(new Date(),7);
}
